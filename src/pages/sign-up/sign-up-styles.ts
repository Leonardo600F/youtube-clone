...
@media(max-width: 349px) {width: 277px}

@media(max-width: 329px) {width: 257px}
...
@media(max-width: 349px) {width: 124px}
...
@media(max-width: 369px) {margin-left: ${({ valid }) => valid ? '-138px' : '-144px'}}
