...
@media(max-height: 619px) {@media(max-width: 619px) {
height: 585px;
top: 302px}}
...
@media (max-height: 585px) {top: 289px}
...
@media (max-height: 600px) {@media (max-width: 599px) {max-height: 46px}}
...
@media (max-height: 625px) {@media (max-width: 599px) {margin-left: 3px}}
