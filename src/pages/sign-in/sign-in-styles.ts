...
@media(max-width: 1152px) {
height: ${({ valid }) => valid ? '37%' : '42.5%'};
}

@media(max-width: 1115px) {
height: ${({ valid }) => valid ? '37%' : '41.5%'};
}

@media(max-width: 1090px) {
height: ${({ valid }) => valid ? '38%' : '43.5%'};
}
...
@media(max-width: 1920px) {
max-width: ${({ valid }) => valid ? '398px' : '98%'};
}
...
@media(max-width: 1200px) {
max-width: ${({ valid }) => valid ? '358px' : '98%'};
}

@media(max-width: 976px) {
max-width: ${({ valid }) => valid ? '368px' : '98%'};
}
...
@media(max-width: 976px) {
max-width: ${({ valid }) => valid ? '368.2px' : '98%'};
}
